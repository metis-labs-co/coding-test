...
export const items: Item[] = [
  ...
  { id: 2, name: "Wireless Mouse", category: "Electronics", price: 29.5, in_stock: true } as unknown as Item,
  ...
  { id: 7, name: "Ergonomic Chair", category: "Furniture", price: 219.99, inStock: true },
];
